...
import 'package:proleca/Fase2/tartaruga_lebre/Dia4/resultado_tartaruga_lebre_dia4_page.dart';
...
class TartarugaLebreDia4Page extends StatefulWidget {

  @override
  _TartarugaLebreDia4State createState() => _TartarugaLebreDia4State();
}

class _TartarugaLebreDia4State extends State<TartarugaLebreDia4Page> {
  ...
  List<String> listaPerguntas = [
    ...
    //Pergunta 6
    "A tartaruga e a lebre se apresentaram animadas. A tartaruga e a lebre se apresentaram a ...",
    //Pergunta 7
    ...
    //Pergunta 10
    "A tartaruga continuou seu percurso concentrada. A tartaruga continuou seu percurso com ...",
    //Pergunta 11
    "O que é isso?",
    //Pergunta 12
    "Para que serve isso?",
    //Pergunta 13
    "Você lembra com que a Lebre conversou durante a corrida?",
     //Pergunta 14
    "O que está acontecendo aqui?",
    //Pergunta 15
      ...
      if ( _indiceQuestao < ultimoIndice ) {
        ...
        Navigator.push( context, 
          MaterialPageRoute(builder: (context) => 
            ResultadoTartarugaLebreDia4Page(
