...
class _TartarugaLebreDia3State extends State<TartarugaLebreDia3Page> {
  ...
  List<String> listaPerguntas = [
    ...
    //Pergunta 7
    "Faltavam alguns dias para a corrida, a pequena tartaruga se tratou de se preparar, comendo alimentos. Faltavam alguns dias para a corrida, a pequena tartaruga se tratou de se preparar, comendo ... ?",
    //Pergunta 8
    "Você lembra quem era considerado o bicho mais lento da floresta?",
    //Pergunta 9
    "Você costuma torcer durante as competições?",
    //Pergunta 10
