...
class TartarugaLebrePrincipalPage extends StatefulWidget {
  @override
  _TartarugaLebrePrincipalPageState createState() => _TartarugaLebrePrincipalPageState();
}

class _TartarugaLebrePrincipalPageState extends State<TartarugaLebrePrincipalPage> {
 void _abrirDia1() {
   Navigator.pushNamed(context, "/TartarugaLebreDia1Page");
  }

  void _abrirDia2() {
    Navigator.pushNamed(context, "/TartarugaLebreDia2Page");
  }


void _abrirDia3() {
    Navigator.pushNamed(context, "/TartarugaLebreDia3Page");
  }

void _abrirDia4() {
    Navigator.pushNamed(context, "/TartarugaLebreDia4Page");
  } 
