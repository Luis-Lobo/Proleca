...
import 'package:proleca/Fase2/raposa_cegonha/Dia4/resultado_raposa_cegonha_dia4_page.dart';
...
class RaposaCegonhaDia4Page extends StatefulWidget {

  @override
  _RaposaCegonhaDia4State createState() => _RaposaCegonhaDia4State();
}

class _RaposaCegonhaDia4State extends State<RaposaCegonhaDia4Page> {
      ...
      if ( _indiceQuestao < ultimoIndice ) {
        ...
        Navigator.push( context, 
          MaterialPageRoute(builder: (context) => 
            ResultadoRaposaCegonhaDia4Page(
