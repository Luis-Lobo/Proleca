...
class RaposaCegonhaPrincipalPage extends StatefulWidget {
  @override
  _RaposaCegonhaPrincipalPageState createState() => _RaposaCegonhaPrincipalPageState();
}

class _RaposaCegonhaPrincipalPageState extends State<RaposaCegonhaPrincipalPage> {
 void _abrirDia1() {
   Navigator.pushNamed(context, "/RaposaCegonhaDia1Page");
  }

  void _abrirDia2() {
    Navigator.pushNamed(context, "/RaposaCegonhaDia2Page");
  }


void _abrirDia3() {
    Navigator.pushNamed(context, "/RaposaCegonhaDia3Page");
  }

void _abrirDia4() {
    Navigator.pushNamed(context, "/RaposaCegonhaDia4Page");
  } 
