...
class CaozinhoPrincipalPage extends StatefulWidget {
  @override
  _CaozinhoPrincipalPageState createState() => _CaozinhoPrincipalPageState();
}

class _CaozinhoPrincipalPageState extends State<CaozinhoPrincipalPage> {
 void _abrirDia1() {
   Navigator.pushNamed(context, "/CaozinhoDia1Page");
  }

  void _abrirDia2() {
    Navigator.pushNamed(context, "/CaozinhoDia2Page");
  }


void _abrirDia3() {
    Navigator.pushNamed(context, "/CaozinhoDia3Page");
  }

void _abrirDia4() {
    Navigator.pushNamed(context, "/CaozinhoDia4Page");
  } 
