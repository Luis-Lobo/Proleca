...
class EstegossauroDia4Page extends StatefulWidget {

  @override
  _EstegossauroDia4State createState() => _EstegossauroDia4State();
}

class _EstegossauroDia4State extends State<EstegossauroDia4Page> {
