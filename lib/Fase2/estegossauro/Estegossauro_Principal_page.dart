...
class EstegossauroPrincipalPage extends StatefulWidget {
  @override
  _EstegossauroPrincipalPageState createState() => _EstegossauroPrincipalPageState();
}

class _EstegossauroPrincipalPageState extends State<EstegossauroPrincipalPage> {
 void _abrirDia1() {
   Navigator.pushNamed(context, "/EstegossauroDia1Page");
  }

  void _abrirDia2() {
    Navigator.pushNamed(context, "/EstegossauroDia2Page");
  }


void _abrirDia3() {
    Navigator.pushNamed(context, "/EstegossauroDia3Page");
  }

void _abrirDia4() {
    Navigator.pushNamed(context, "/EstegossauroDia4Page");
  } 
