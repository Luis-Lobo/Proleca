...
class ArvoreCintiaPrincipalPage extends StatefulWidget {
  @override
  _ArvoreCintiaPrincipalPageState createState() => _ArvoreCintiaPrincipalPageState();
}

class _ArvoreCintiaPrincipalPageState extends State<ArvoreCintiaPrincipalPage> {
 void _abrirDia1() {
   Navigator.pushNamed(context, "/ArvoreCintiaDia1Page");
  }

  void _abrirDia2() {
    Navigator.pushNamed(context, "/ArvoreCintiaDia2Page");
  }


void _abrirDia3() {
    Navigator.pushNamed(context, "/ArvoreCintiaDia3Page");
  }

void _abrirDia4() {
    Navigator.pushNamed(context, "/ArvoreCintiaDia4Page");
  } 
