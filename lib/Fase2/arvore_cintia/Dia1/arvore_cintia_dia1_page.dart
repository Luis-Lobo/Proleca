...
import 'package:proleca/Fase2/arvore_cintia/Dia1/resultado_arvore_cintia_dia1_page.dart';
...
class ArvoreCintiaDia1Page extends StatefulWidget {
  @override
  _ArvoreCintiaDia1State createState() => _ArvoreCintiaDia1State();
}

class _ArvoreCintiaDia1State extends State<ArvoreCintiaDia1Page> {
    ...
    setState(() {
      ...
      if (_indiceQuestao < ultimoIndice) {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => ResultadoArvoreCintiaDia1Page(
  ...
  _anteriorPergunta() {
    setState(() {
      ...
      if (_indiceQuestao <= ultimoIndice && _indiceQuestao > 0) {
        ...
        print(
            "lista = ${pontuacaoAnterior.remove(pontuacaoAnterior.length - 1)}");
      } else {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        preferredSize:
            Size.fromHeight(MediaQuery.of(context).textScaleFactor * 64),
        child: AppBar(
                    ...
                    return Container(
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                            ...
                            onTap: () {
                              if (listaNomes[index] == respostaCerta &&
                                  respostaCerta != "") {
                                if (contador == 3) {
                                  alertaRespostaCerta(context);
                                  listaTentativas.add(
                                      "Acertou na primeira tentativa. Resposta: ${respostaCerta}.");
                                  setState(() {
                                    pontosTentativa1 = pontosTentativa1 + 3;
                                    _proximaPergunta();
                                ...
                                if (contador == 2) {
                                  alertaRespostaCerta(context);
                                  listaTentativas.add(
                                      "Acertou na segunda tentativa. Resposta: ${respostaCerta}.");
                                  setState(() {
                                    pontosTentativa2 = pontosTentativa2 + 2;
                                    _proximaPergunta();
                                ...
                                if (contador == 1) {
                                  alertaRespostaCerta(context);
                                  listaTentativas.add(
                                      "Acertou na terceira tentativa. Resposta: ${respostaCerta}.");
                                  setState(() {
                                    pontosTentativa3 = pontosTentativa3 + 1;
                                    _proximaPergunta();
