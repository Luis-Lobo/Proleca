...
class _CotoviaDia2State extends State<CotoviaDia2Page> {
  ...
  List<String> listaPerguntas = [
    ...
    "Para que serve isso?",
    //Pergunta 3
    "Aqui é o lugar perfeito para fazer o meu ninho e proteger meus ovos. Aqui é o lugar perfeito para fazer o meu ninho e proteger meus ...",
    //Pergunta 4
    ...
    //Pergunta 16
    "Você lembra o que a cotovia recomendou aos filhotes?"
    ];
