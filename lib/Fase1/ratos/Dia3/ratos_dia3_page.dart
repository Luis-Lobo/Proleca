...
class _RatosDia3State extends State<RatosDia3Page> {
  ...
  List<String> listaPerguntas = [
    //Pergunta 1
    "O que faz uma pessoa que vive na cidade?",
    //Pergunta 2
    "O que o ratinho Dom aceitou?",
    //Pergunta 3
    "Para que serve um convite?",
    //Pergunta 4
    "Como o ratinho Dom está se sentindo?",
    //Pergunta 5
    "Meu estômago está roncando mais alto do que um motor de caminhão velho. Meu estômago está roncando mais alto do que um motor de caminhão ...",
    //Pergunta 6
    "Você já viu o olho de alguém brilhando?",
    //Pergunta 7
    "Você lembra o que tinha na mesa?",
    //Pergunta 8
    "O que está acontecendo aqui?",
    //Pergunta 9
    "Como o ratinho se sentiu ao ver os carros passando?",
    //Pergunta 10
    "O que você vê na mesa?",
    //Pergunta 11
    "Você já comeu um bolo de chocolate delicioso?",
    //Pergunta 12
    "Que ingredientes são usados para fazer um bolo de chocolate?",
    //Pergunta 13
    "Você lembra o que os ratinhos fizeram quando a porta abriu?",
    //Pergunta 14
    "O que o dono da dispensa abriu?",
     //Pergunta 15
    "Para que serve a porta?",
    //Pergunta 16
    "Mas eu vou voltar para minha casinha caipira e para as minhas comidinhas. Mas eu vou voltar para minha casinha caipira e para as minhas ...",      
    ];
