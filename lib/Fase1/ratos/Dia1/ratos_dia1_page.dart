...
import 'package:proleca/Fase1/ratos/Dia1/resultado_ratos_dia1_page.dart';
...
class RatosDia1Page extends StatefulWidget {

  @override
  _RatosDia1State createState() => _RatosDia1State();
}

class _RatosDia1State extends State<RatosDia1Page> {
  ...
  List<String> listaPerguntas = [
    ...
    //Pergunta 6
    "Você lembra o que que o Zé preparou?",
    //Pergunta 7
