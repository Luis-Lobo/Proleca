...
class ResultadoMonstroCamaDia4Page extends StatelessWidget {
  ...
  ResultadoMonstroCamaDia4Page({Key key, 
      ...
      appBar: PreferredSize(
        ...
        title: Center(
          child: Container(
            ...
            child: Text("Há um monstro embaixo da minha cama - Resultado Dia 4",
            style: TextStyle(
