...
import 'package:proleca/Fase1/monstro_cama/Dia4/resultado_monstro_cama_dia4_page.dart';
...
class MonstroCamaDia4Page extends StatefulWidget {

  @override
  _MonstroCamaDia4State createState() => _MonstroCamaDia4State();
}

class _MonstroCamaDia4State extends State<MonstroCamaDia4Page> {
  ...
  List<String> listaPerguntas = [
    ...
    //Pergunta 6
    "Como foi o arroto azedo da criatura?",
    //Pergunta 7
  ...
  List<String> listaNomesTotal = [
    ...
    "", "", "", 
    "Escovado os dentes", "Comido", "Calçado", 
