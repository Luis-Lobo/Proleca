...
class ResultadoMonstroCamaDia2Page extends StatelessWidget {
  ...
  ResultadoMonstroCamaDia2Page({Key key, 
      ...
      appBar: PreferredSize(
        ...
        title: Center(
          child: Container(
            ...
            child: Text("Há um monstro embaixo da minha cama - Resultado Dia 2",
            style: TextStyle(
