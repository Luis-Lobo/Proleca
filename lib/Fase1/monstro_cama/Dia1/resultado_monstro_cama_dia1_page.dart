...
class ResultadoMonstroCamaDia1Page extends StatelessWidget {
  ...
  ResultadoMonstroCamaDia1Page({Key key, 
      ...
      appBar: PreferredSize(
        ...
        title: Center(
          child: Container(
            ...
            child: Text("Há um monstro embaixo da minha cama - Resultado Dia 1",
            style: TextStyle(
