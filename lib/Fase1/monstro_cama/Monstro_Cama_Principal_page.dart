...
class MonstroCamaPrincipalPage extends StatefulWidget {
  @override
  _MonstroCamaPrincipalPageState createState() => _MonstroCamaPrincipalPageState();
}

class _MonstroCamaPrincipalPageState extends State<MonstroCamaPrincipalPage> {
 void _abrirDia1() {
   Navigator.pushNamed(context, "/MonstroCamaDia1Page");
  }

  void _abrirDia2() {
    Navigator.pushNamed(context, "/MonstroCamaDia2Page");
  }

void _abrirDia3() {
    Navigator.pushNamed(context, "/MonstroCamaDia3Page");
  }

void _abrirDia4() {
    Navigator.pushNamed(context, "/MonstroCamaDia4Page");
  } 
