...
class ResultadoMonstroCamaDia3Page extends StatelessWidget {
  ...
  ResultadoMonstroCamaDia3Page({Key key, 
      ...
      appBar: PreferredSize(
        ...
        title: Center(
          child: Container(
            ...
            child: Text("Há um monstro embaixo da minha cama - Resultado Dia 3",
            style: TextStyle(
