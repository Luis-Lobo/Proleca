...
import 'package:proleca/Fase1/cigarra_formiga/Dia1/resultado_cigarra_formiga_dia1_page.dart';
...
class CigarraFormigaDia1Page extends StatefulWidget {

  @override
  _CigarraFormigaDia1State createState() => _CigarraFormigaDia1State();
}

class _CigarraFormigaDia1State extends State<CigarraFormigaDia1Page> {
      ...
      if ( _indiceQuestao < ultimoIndice ) {
        ...
        Navigator.push( context, 
          MaterialPageRoute(builder: (context) => 
            ResultadoCigarraFormigaDia1Page(
