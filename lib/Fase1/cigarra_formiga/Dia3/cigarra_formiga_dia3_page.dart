...
class _CigarraFormigaDia3State extends State<CigarraFormigaDia3Page> {
  ...
  List<String> listaPerguntas = [
    ...
    //Pergunta 12
    "12-A mãe da formiguinha ao ver aquilo ficou feliz. \nA mãe da formiguinha ao ver aquilo ficou ...",
    //Pergunta 13
    "O que você vê nesta página?",
    //Pergunta 14
    "Você costuma usar cachecol no frio?",
     //Pergunta 15
    "15-Você lembra quem não conseguia deixar de pensar na cigarra?",
    //Pergunta 16
    "16-O que a cigarra pode fazer para se prevenir dos tempos difíceis?",      
    ];
  ...
  List<Image> listaImagensTotal = [
   ...
   Image.asset(
    ...
    Image.asset(
      "imagens/CigarraFormiga/Dia 01 e 04/neve.png",
      fit: BoxFit.contain,
    ),
    Image.asset(
      "imagens/CigarraFormiga/Dia 01 e 04/fogueira.png",
      fit: BoxFit.contain,
    ),
    Image.asset(
      "imagens/CigarraFormiga/Dia 01 e 04/árvore.png",
      fit: BoxFit.contain,
    ),
    Image.asset(
      "imagens/sim.png",
